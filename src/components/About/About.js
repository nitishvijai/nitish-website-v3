    ...
    <div className={mobilePortrait ? (mode === 'dark' ? 'darkgradient_mobile' : 'lightgradient_mobile') : (mode === 'dark' ? 'darkgradient' : 'lightgradient')} onMouseMove={(e) => moveGradient(e)} ref={gradient}>
      ...
      <div className={mobilePortrait ? styles.parent_mobile : styles.parent}>
        ...
        <div className={mobilePortrait ? styles.aboutMe_mobile : styles.aboutMe}>
          <p className={mobilePortrait ? styles.paragraph_mobile : styles.paragraph}>Hi there! I'm Nitish, an associate software engineer working at <a className="pgLink" href="https://www.capitalone.com/" target="_blank" rel="noreferrer">Capital One</a> in the Cyber DevSecOps Engineering team. I also recently graduated from the <a className="pgLink" target="_blank" rel="noreferrer" href="https://umich.edu">University of Michigan</a> in April 2023 with majors in computer science and data science.</p>
