    ...
    <div className={mobilePortrait ? (mode === 'dark' ? styles.darkgradient_mobile : styles.lightgradient_mobile) : (mode === 'dark' ? styles.darkgradient : styles.lightgradient)} onMouseMove={(e) => moveGradient(e)} ref={gradient}>
      ...
      <div className={mobilePortrait ? styles.parent_mobile : styles.parent}>
        ...
        <div className={mobilePortrait ? styles.aboutMe_mobile : styles.aboutMe}>
          <p className={mobilePortrait ? styles.paragraph_mobile : styles.paragraph}>Hi there! I'm Nitish, a recent graduate of the <a className={styles.pgLink} target="_blank" rel="noreferrer" href="https://umich.edu">University of Michigan</a> where I double majored in computer science and data science. I plan on joining <a className={styles.pgLink} href="https://www.capitalone.com/" target="_blank" rel="noreferrer">Capital One</a> as an Associate Software Engineer in August.</p>
          ...
          <ul id={mobilePortrait ? styles.list_mobile : styles.list}>
            ...
            <li>🎶 I enjoy listening and dancing to Indian/Tamil music and have frequently taken part in Michigan IASA's Annual Cultural Show -- check out my most recent performance <a className={styles.pgLink} target="_blank" href='https://www.youtube.com/watch?v=0jPigyHwCYg' rel="noreferrer">here</a></li>
            <li>✈️ I love traveling -- check out my Traveling <Link to="/travels" className={styles.pgLink}>page</Link> to learn more about my adventures</li>
            <li>🏍️ I have a motorcycle license</li>
            <li>🏋🏽 I love the gym and can't go a day without lifting weights or power walking</li>
            <li>🍳🔥 Finally, I'm also a below-average cook -- please suggest some recipes while you're <Link to="/contact" className={styles.pgLink}>here</Link>, thanks!</li>
          </ul>
        </div>
      </div>
      <Footer />
