    ...
    <div className={mobilePortrait ? (mode === 'dark' ? styles.darkgradient_mobile : styles.lightgradient_mobile) : (mode === 'dark' ? styles.darkgradient : styles.lightgradient)} onMouseMove={(e) => moveGradient(e)} ref={gradient}>
      ...
      <div className={mobilePortrait ? styles.parent_mobile : styles.parent}>
        ...
        <div className={mobilePortrait ? styles.aboutMe_mobile : styles.aboutMe}>
          <p className={mobilePortrait ? styles.paragraph_mobile : styles.paragraph}>Hi there! I'm Nitish, a recent graduate of the <a className={styles.pgLink} target="_blank" href="https://umich.edu">University of Michigan</a> where I double majored in computer science and data science. I plan on joining <a className={styles.pgLink} href="https://www.capitalone.com/" target="_blank">Capital One</a> as an Associate Software Engineer in August.</p>
          ...
          <ul id={mobilePortrait ? styles.list_mobile : styles.list}>
            ...
            <li>🏋🏽 I'm a fitness freak -- find me at the gym every day either running or lifting weights</li>
